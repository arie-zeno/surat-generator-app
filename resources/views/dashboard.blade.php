                                ...
                                <div class="relative bg-white rounded-lg shadow-sm ">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <form action="{{ route('helper.upload') }}" method="POST" >
                                            @csrf
                                            <div class="mb-5">
                                                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 ">Nama</label>
                                                <input name="nama" type="text" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required placeholder="Contoh : Thari Maulida"/>
                                            </div>

                                            <div class="mb-5">
                                                <label for="nip" class="block mb-2 text-sm font-medium text-gray-900 ">NIP</label>
                                                <input name="nip" type="text" id="nip" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required placeholder="Contoh : 2378213 8237 82378 88"/>
                                            </div>

                                            <div class="mb-5">
                                                <label for="ket" class="block mb-2 text-sm font-medium text-gray-900 ">Keterangan</label>
                                                <input name="ket" type="text" id="ket" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required placeholder="Contoh : Kelompok pokja 2"/>
                                            </div>
