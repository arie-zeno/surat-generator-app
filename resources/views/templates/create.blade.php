        ...
        <div class="w-3/12 bg-white shadow p-3 fixed right-0 top-0 mt-14 bottom-0 overflow-y-auto">
            ...
            <div class="py-2 px-4 shadow rounded">
                ...
                @foreach($helper as $data)
                    <ul class=" mb-3  text-sm  text-gray-900 bg-white border border-gray-200 rounded-lg   ">
                        <li class="w-full px-4 py-2 border-b border-gray-200 rounded-t-lg "><span class="font-semibold">Nama</span> : {{$data->nama}}</li>
                        <li class="w-full px-4 py-2 border-b border-gray-200 "><span class="font-semibold">NIP</span> : {{$data->nip}}</li>
